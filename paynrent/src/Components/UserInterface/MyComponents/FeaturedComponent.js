...
export default function FeaturedComponent(props) {
    ...
    return (<div>
        <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: 10, paddingTop: 10, width: '94%' }}>
            <span style={{color:'#353b48', fontWeight: "bolder", fontSize: 24 }}>{props.title}</span>
