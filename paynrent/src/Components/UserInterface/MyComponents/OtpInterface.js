  ...
  const verifyOtp = () => {
    ...
    if (props.getOtp == props.generatedOtp) {
      ...
      if (userDetails.status) {
        props.handleClose()
        dispatch({ type: 'ADD_USER', payload: [props.mobile, userDetails.date] })
    ...
    <div>
      <Grid container spacing={3} style={{ width: 300, padding: 20 }}>
        ...
        <Grid item xs={3}>
          ...
          }} id="t2" onChange={handleTextTwoChange} />
        </Grid>
        <Grid item xs={3}>
          <TextField InputProps={{
          ...
          }} id="t3" onChange={handleTextThreeChange} />
        </Grid>
        <Grid item xs={3}>
          <TextField InputProps={{
          ...
          }} id="t4" onChange={handleTextFourChange} />
        </Grid>
        <Grid xs={12} item>
        ...
        <Grid xs={12} item>
          <Button onClick={verifyOtp} fullWidth variant="contained">Verify</Button>
        </Grid>
      </Grid>
