...
export default function VehicleComponent(props) {
    ...
    return (<div style={{ width: 250, display: 'flex', background: '#fff', padding: 10, borderRadius: 20, flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', marginTop: 8, height: 30, alignItems: 'baseline', justifyContent: 'space-between' }}>
                ...
                <span>
                    <Button
                        ...
                        variant="contained"
                        style={{ background: 'linear-gradient(270deg,#1caba2,20%,#1c7fab)' }}>Book &gt;</Button>
                </span>
